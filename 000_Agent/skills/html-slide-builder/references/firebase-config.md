...
const firebaseConfig = {
  apiKey: "AIzaSyC-Bmfhs-TN1TSfDkpkGEqbZnOANtT6zDw",
  authDomain: "ahmo-series.firebaseapp.com",
  projectId: "ahmo-series",
  storageBucket: "ahmo-series.firebasestorage.app",
  messagingSenderId: "1081491085278",
  appId: "1:1081491085278:web:cfe55d364df3ae1b9d5c69"
};
```

Firebase 專案：`ahmo-series`
...
<script type="module">
  ...
  // ⚠️ 使用 AntiGravity 全域分流架構：收攏於 slides/<slug>/wordcloud 下
  const wordsRef = collection(fdb, 'slides', '<slug>', 'wordcloud');
...
<script type="module">
  ...
  // ⚠️ 使用 AntiGravity 全域分流架構：收攏於 slides/<slug>/polls/results 下
  const pollRef = doc(fdb, 'slides', '<slug>', 'polls', 'results');
